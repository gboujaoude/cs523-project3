...
import application.layered_immune_sys_test.BystanderCell;
import application.bcell_response_test.CytokineData;
import application.bcell_response_test.TCytokine;
import application.layered_immune_sys_test.Virus;
...
public class TCell extends Circle2D implements PulseEntity {
    ...
    private void notifyBCells(CytokineData data) {
        new BCytokine(this.getLocationX(),this.getLocationY(),data.locationX,data.locationY);
    }
